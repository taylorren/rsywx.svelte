...
<div>
  <Card img={book.img}>
    ...
    <ButtonGroup>
    <Button href="/books/{book.bookid}.html" color="blue">详细信息&nbsp;<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right-square-fill" viewBox="0 0 16 16">
