  ...
  <Footer footerType="socialmedia">
    <div class="md:flex md:justify-between">
      ...
      <div class="grid grid-cols-4 gap-8 sm:gap-6 sm:grid-cols-4">
        <div>
          <h2
            class="mb-7 text-sm font-semibold text-gray-900 uppercase dark:text-white"
          >
            使用的技术
          </h2>
          <FooterLinkGroup>
            ...
            >
            <FooterLink liClass="mb-4" href="https://tailwindcss.com/"
        ...
        <div>
          <h2
            class="mb-5 text-sm font-semibold uppercase text-gray-900 dark:text-white"
          >
            版权
          </h2>
          <FooterLinkGroup>
