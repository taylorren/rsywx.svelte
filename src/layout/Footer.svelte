    ...
    <div class="md:flex md:justify-between">
      ...
      <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
        ...
        <div>
          ...
          <FooterLinkGroup>
            <FooterLink liClass="mb-4" href="https://twitter.com/taylorren">Twitter</FooterLink>
            <FooterLink liClass="mb-4" href="https://www.facebook.com/taylor.ren">Facebook</FooterLink>
            <FooterLink liClass="mb-4" href="https://github.com/taylorren">GitHub</FooterLink>
          </FooterLinkGroup>
        </div>
        <div>
          <h2
